...
public class lex{
   ...
   obj o=new obj();
    ...
    void verificaToken(String t,StringTokenizer st){
        ...
        ///*hoy*/StringTokenizer sinesp=new StringTokenizer(t);
        //tokens=sinesp;
        ///*hoy*/while(sinesp.hasMoreTokens()!=false){
                //Convertimos el string a un array
            ///*hoy*/aux=sinesp.nextToken();//esta es la cadena a observar
                //System.out.println("Cadena sin espacios:"+aux);
                char array[]=t.toCharArray();///*hoy*/char array[]=aux.toCharArray();
