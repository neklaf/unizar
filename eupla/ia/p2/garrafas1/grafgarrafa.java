...
class metodos{
   ...
   void DibujaGarrafaVacia(Graphics g,int tipo){
	...
	//{{DECLARE_CONTROLS
	//}}
	static java.util.ResourceBundle metodosBundle = java.util.ResourceBundle.getBundle("metodosBundle");
}
public class grafgarrafa extends Applet{
	...
	//{{DECLARE_CONTROLS
	//}}
	static java.util.ResourceBundle grafgarrafaBundle = java.util.ResourceBundle.getBundle("grafgarrafaBundle");
}