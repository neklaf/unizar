...
public class CentralProveedores {
    ...
    public CentralProveedores() {
    }
    
    public CentralProveedores(String cif, String localizacion, ArrayList tfno, String nombre, String numcuenta, String persContacto, String web, String email, boolean eliminado, ArrayList producto) {
        Iterator i;
    ...
    public void addProducto(CentralProductosProveedores nuevo_producto){
    ...
    public void deleteProducto(CentralProductosProveedores nuevo_producto){
