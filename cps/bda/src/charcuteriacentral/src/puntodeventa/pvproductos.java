 ...
 * Productos.java
 *
 * Created on 12 de febrero de 2005, 13:57
 */
...
public class PVProductos {
    ...
    public PVProductos(String ref, String nombre, String descripcion, double precio, double unidades, boolean eliminado, PVPuntoDistribucion departamento/*, boolean esRegional*/){
        this.ref = ref;
        this.nombre = nombre;
