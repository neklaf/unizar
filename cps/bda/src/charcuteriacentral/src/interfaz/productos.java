            ...
            if(row >= 0){
                ...
                try{
                    ...
                    if(!newRef.equals("")){
                        ...
                        if((new MantenimientoDB.Productos().modificar(oldRef, newRef, nombre, descripcion, precio.doubleValue(), unidades.doubleValue(), eliminado.booleanValue(), zona.intValue()))==1){
