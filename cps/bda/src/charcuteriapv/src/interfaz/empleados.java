...
public class Empleados extends javax.swing.JFrame {
    ...
    String cols[] = new String [] {"nif", "apellidos", "nombre", "%Comision", "activo", "cargo", "*numCuenta", 
                                    "*jefe", "sueldoBase", "fechaAltaContrato", "domicilio"};
    Vector vCol;                                
    ...
    private final int JEFE = 7;
    private final int SUELDO = 8;
    private final int FECHA = 9;
    private final int DOMICILIO = 10;
    ...
    public void setPedidosEmp(Pedidos v){
        vPedidosEmp = v;
    }
    ...
    public void visualiza(int zona){
        ...
        v = (Vector)new MantenimientoDB.Empleados().buscar("-1", 2);
        ...
        if (v.size()!=0){
            ...
            while (i < v.size()){
                ...
                if(clase.endsWith("Central.CentralEmpleados")){
                    ...
                    //{"nif", "apellidos", "nombre", "%Comision", "activo", "cargo", "*numCuenta", "*jefe", "sueldoBase", "fechaAltaContrato", "domicilio"};
                    ...
                    //Tenemos que contemplar la posibilidad de que la lista de telefonos de empresa este vac’a!!
    ...
    private static void modificaTfno(Hashtable h, String nif, String tel, String tel2){
        if((h!=null)&&(nif!=null)&&(tel!=null)&&(tel2!=null)){
            ...
            if(l!=null){
                ...
                System.out.println("El nif "+nif+" no tiene telefonos");
        }else
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            Class[] types = new Class [] {
                java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.Double.class, java.lang.Boolean.class, java.lang.String.class, java.lang.String.class, java.lang.String.class, java.lang.Double.class, java.lang.Object.class, java.lang.String.class
            };
        ...
        ventas.setBounds(160, 360, 75, 29);
    ...
    private void ventasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ventasActionPerformed
        ...
        if(!jTable1.getColumnSelectionAllowed() && jTable1.getRowSelectionAllowed()){
            ...
            if(row >= 0){
                try{
                    String nif = ((String)jTable1.getValueAt(row, NIF)).trim();
                    vPedidosEmp.visualiza("-1", nif, "-1");
                }catch(NullPointerException nu){
        ...
        if(!jTable1.getColumnSelectionAllowed() && jTable1.getRowSelectionAllowed()){
            ...
            if(row >= 0){
                try{
                    ...
                    //CAMBIAR POR EL CODIGO CORRECTO!! Mirar Pedidos.detallesActionPerformed
                    try{
                        ArrayList l;
                        l = (ArrayList)tEmpr.get(ni);
                        vTfnosEmpr.visualiza(ni, false);
                    }catch(NullPointerException nu){ //La funcion get lanza NullPointerException si la clave es null
                ...
                try{
                    ...
                    try{ //Este try es debido al parseo de la fecha
                        ...
                        if(!newNif.equals("")){
                            ...
                            if((new MantenimientoDB.Empleados().modificar(oldNif, newNif, domicilio, cargo, comision.doubleValue(), fecha, nombre, apellidos, sueldo.doubleValue(), cuenta, jefe, activo.booleanValue()))==1){
                                if(oldNif != newNif){
                                    m.setValueAt(newNif, row, NIF); //Cambiamos el valor del nif en la tabla
                                    //Mantenemos coherencia en los hashtables
                                    tPers.put(newNif, tPers.get(oldNif));
                                    tEmpr.put(newNif, tEmpr.get(oldNif));
                                    tPers.remove(oldNif);
                                    tEmpr.remove(oldNif);
                                }
        ...
        if(!jTable1.getColumnSelectionAllowed() && jTable1.getRowSelectionAllowed()){
            ...
            if(row >= 0){
                try{
                    ...
                    try{
                        ArrayList l;
                        l = (ArrayList)tPers.get(ni); //hashtable.get(nif) devuelve un Object de ahi el cast
            ...
            if(row >= 0){
                ...
                try{
                    ...
                    try{
                        ...
                        if(tp!=null){
                            if((new MantenimientoDB.Empleados().insertar(nif, domicilio, cargo, activo.booleanValue(), comision.doubleValue(), tp, te, fecha, nombre, apellidos, sueldo.doubleValue(), cuenta, jefe)) == 1)
        ...
        if(!jTable1.getColumnSelectionAllowed() && jTable1.getRowSelectionAllowed()){
            ...
            if(row >= 0){
                ...
                try{
                    Vector v;
                    nif = ((String)jTable1.getValueAt(row, NIF)).trim();
                    System.out.println("El nif del empleado es: "+nif);
                    if(!nif.equals("")){ //Tenemos que evitar que se seleccione una cadena vacia como nif
                        //public Vector buscar(String nif, int estado)
                        v = new MantenimientoDB.Empleados().buscar(nif, 2);
                        if(v != null){
                            if(nif.equals("-1"))
                ...
                try{
                    ...
                    if(!nif.equals("")){ //Tenemos que evitar que se seleccione una cadena vacia como nif
                        if(activo.booleanValue()==true){
                            ...
                            out.setText("El empleado tiene que estar activo para ser eliminado");
                    }else
