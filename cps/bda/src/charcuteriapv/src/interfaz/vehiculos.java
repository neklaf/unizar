...
public class Vehiculos extends javax.swing.JFrame {
    ...
    public void setPedidosVeh(Pedidos v){
        vPedidosVeh = v;
    }
    ...
    public void visualiza(int zona){
        ...
        v = (Vector)new MantenimientoDB.Vehiculos().buscar("-1");
        ...
        if(v.size()!=0){
            ...
            while (i < v.size()){
                ...
                if(clase.endsWith("Central.CentralVehiculos")){
                    ...
                    vfields.addElement(new Integer(ConexionBD.constantes.NODO_PROPIO));
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        pedidos.setBounds(40, 310, 80, 29);
    ...
    private void pedidosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pedidosActionPerformed
        ...
        if(!jTable1.getColumnSelectionAllowed() && jTable1.getRowSelectionAllowed()){
            ...
            if(row >= 0){
                try{
                    String matricula = ((String)jTable1.getValueAt(row, MATRICULA)).trim();
                    vPedidosVeh.visualiza("-1", "-1", matricula);
            ...
            if(row >= 0){
                try{
                    ...
                    if(!matricula.equals("")){
                        Vector v;
                        //public Vector buscar(String matricula)
                        v = new MantenimientoDB.Vehiculos().buscar(matricula);
                        if(v!=null){
            ...
            if(row >= 0){
                ...
                try{
                    ...
                    try{
                        ...
                        m.setValueAt(new Integer(ConexionBD.constantes.NODO_PROPIO), row, DEPARTAMENTO);
                        ...
                        if((new MantenimientoDB.Vehiculos().insertar(matricula, modelo, fechaProxITV, fechaCompra, precioCompra.doubleValue(), eliminado.booleanValue()))==1)
                ...
                try{
                    ...
                    try{
                        ...
                        if(!newMatricula.equals("")){
                            ...
                            if((new MantenimientoDB.Vehiculos().modificar(oldMatricula, newMatricula, modelo, fechaProxITV, fechaCompra, precioCompra.doubleValue(), eliminado.booleanValue()))==1){
