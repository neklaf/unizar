...
public class PuntoVenta extends javax.swing.JFrame {
    ...
    public PuntoVenta() {
        ...
        setSize(600,470);
        setTitle("Ventana de Punto de Venta");
        setResizable(false);
    }
            ...
            if(row >= 0){
                ...
                try{
                    ...
                    if(z!=null){
                        ...
                        if(z.intValue() == ConexionBD.constantes.NODO_PROPIO){
                            if((new MantenimientoDB.PuntoDistribucion().modificar(l, t) == 1))
                                out.setText("Modificado con exito");
                            else
                                out.setText("Error al modificar");
                        }else
                                out.setText("ÁNo es posible modificar este punto de venta!");
                        }else
