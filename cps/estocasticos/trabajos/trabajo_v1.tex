...
%Este es un ejemplo de como cambiar el tamaño de la letra en LaTeX
%\Large{Powered by \LaTeX.}

%Vamos a empezar construyendo la estructura que va a tener el fichero en cuestión

\section{Introducción del problema}
%El objetivo de este trabajo será el explicar el método de dimensionar una centralita de telecomunicaciones, en la que
%tendremos unas entradas que serán líneas telefónicas analógicas, y un conjunto de salidas que conectarán con la jerarquía de centralitas que compongan
%nuestra red telefónica.
%Para tener una idea más clara de la situación en la que nos encontramos, vamos a ver una gráfico que nos explica visualmente el contexto del problema:
...
%Esta es la representación de una matriz!!!
...
% Para escribir la 'ñ' deberemos escribir '~n' en el texto esto es con el paquete babel
...
% Despues tenemos que cambiar también \text{} (dentro de las formulas matematicas) por \textrm{}
