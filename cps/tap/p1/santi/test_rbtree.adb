-- Programa de prueba para el módulo de árbol Rojinegro
...
procedure test_rbtree is
    ...
    nBorrados: integer; -- Número de borrados realizados
    exito: boolean;
    ret: ustring;
...
begin
    ...
    put_line("Practica 1 - Tecnicas Avanzadas de Programación");
    put_line("Programa de prueba para el módulo de ÁRBOL ROJINEGRO");
    ...
    put(fichero_salida,"TEST ROJINEGRO | Tamaño:"); put(fichero_salida, longitud); put(fichero_salida, ", Búsquedas:"); 
