-- Programa de prueba para el módulo de árbol AVL
...
begin
    ...
    put_line("Programa de prueba para el módulo de ÁRBOL AVL");
   ...
   -- Se abre el fichero de resultados y se prepara la cabecera de este test
    ...
    put(fichero_salida,"TEST AVL | Tamaño:"); put(fichero_salida, longitud); put(fichero_salida, ", Búsquedas:"); 
